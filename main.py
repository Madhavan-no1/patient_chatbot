...
MODEL_URL = "https://huggingface.co/TheBloke/Llama-2-7B-GGML/resolve/main/llama-2-7b.ggmlv3.q8_0.bin"
...
def download_model():
    if not os.path.exists(MODEL_PATH):
        print(f"Downloading LLaMA model from {MODEL_URL}...")
